...
export default function FloatingCall() {
  return (
    ...
    >
      <Phone size={24} className="animate-fade-in pointer-events-none" />
      <span className="absolute -top-1 -right-1 flex h-4 w-4 pointer-events-none">
        <span className="absolute inline-flex h-full w-full animate-ping-slow rounded-full bg-gold-400 opacity-75"></span>
